...
import com.example.ws.sebelumuas.exceptions.NonexistentEntityException;
import com.example.ws.sebelumuas.exceptions.PreexistingEntityException;
...
public class BarangJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("com.example_ws.sebelumuas_jar_0.0.1-SNAPSHOTPU");
